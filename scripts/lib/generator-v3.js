...
5. DATA TABLE: Include exactly 1 styled HTML comparison table (<table class="comparison-table">) with at least 3 columns and 4 rows of real protocol metrics (TPS, TVL, APY, fees, etc.). No placeholder values — use sourced figures only.
