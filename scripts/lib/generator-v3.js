...
5. DIAGRAMS: You must include exactly 1 Mermaid.js diagram every 300-400 words (approx. 2 diagrams total). Wrap them in: <pre class="mermaid"> graph TD; ... </pre>. Ensure they accurately map to the architecture being discussed.
